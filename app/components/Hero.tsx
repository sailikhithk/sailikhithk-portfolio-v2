...
const socialLinks = [
  { href: "https://www.linkedin.com/in/sailikhithk", icon: "fa-linkedin", label: "LinkedIn" },
  { href: "https://github.com/sailikhithk",          icon: "fa-github",   label: "GitHub"   },
  { href: "mailto:sailikhithcse@gmail.com",           icon: "fa-envelope", label: "Email"    },
  { href: "https://twitter.com/codewithsai",          icon: "fa-twitter",  label: "Twitter"  },
];
...
export default function Hero() {
  return (
    <header
      ...
      style={{ backgroundColor: "var(--bg)", paddingTop: "120px", paddingBottom: "60px", width: "100%", display: "block" }}
    >
      <div className="section-inner" style={{ textAlign: "center" }}>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.2 }}>
          <span className="block uppercase font-bold" style={{ fontFamily: "var(--font-montserrat), sans-serif", fontSize: "clamp(1.5rem, 4vw, 3rem)", letterSpacing: "0.05em" }}>
            Sai Likhith Kanuparthi
          </span>

          <hr className="star-divider star-light mx-auto mt-4" />

          <span className="block font-light" style={{ fontSize: "clamp(1rem, 2.5vw, 1.75rem)" }}>
            Sr. Software Engineer — ML Infrastructure &amp; AI Engineering · Airbnb
          </span>

          <p className="mt-4 mx-auto max-w-2xl" style={{ fontSize: "1rem", letterSpacing: "0.08em", lineHeight: "1.7", color: "#ddd" }}>
